/**
 */
package edu.kit.kastel.sdq.coupling.models.identifier.util;

import edu.kit.kastel.sdq.coupling.models.identifier.*;
 ...
 * <!-- end-user-doc -->
 * @see edu.kit.kastel.sdq.coupling.models.identifier.IdentifierPackage
 * @generated
 */
public class IdentifierSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case IdentifierPackage.IDENTIFIED_ELEMENT: {
