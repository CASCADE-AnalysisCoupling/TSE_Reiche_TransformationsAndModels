...
public class CodeQLJPMailPaths {
	...
	private static final String ADVERSARIES_MODEL_NAME= "jpmail";
	...
	public static final String EVAL_REPO_SPECIFIC_PATH = "CaseStudies_CouplingSpecificationBasedAnalyses_TSE/Cases/Systems/JPMail";
	
	private static final String PATH_PATTERN = "%s/%s.%s";
	private static final String ACCESS_ANALYSIS_RESULT_FILE_NAME = "AccessAnalysisResultWithCodeQL4JPMail";
	
	private static final String MODELS_PATH_APPENDIX = "codeql";
	public static final String MODELS_BASE_PATH = String.format("%s.%s", "Models/edu.kit.kastel.sdq.coupling.casestudy.jpmail.model.accessanalysis", MODELS_PATH_APPENDIX);
