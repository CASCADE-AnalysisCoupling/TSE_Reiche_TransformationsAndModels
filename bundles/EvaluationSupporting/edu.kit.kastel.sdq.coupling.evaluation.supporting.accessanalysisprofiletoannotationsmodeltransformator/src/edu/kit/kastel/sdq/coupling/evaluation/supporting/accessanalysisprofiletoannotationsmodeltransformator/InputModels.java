...
public class InputModels {
	...
	public InputModels(Repository repository, ProfileApplication profile) {
		super();
	...
	public static InputModels createModelsFromFiles(String repositoryFilePath) {
...
//				.getContents().get(0);
		...
		return new InputModels(repository, profile);
	}
}
