...
import edu.kit.kastel.sdq.coupling.alignment.accessanalysis2codeql.AccessAnalysis2CodeQLHandler;
import edu.kit.kastel.sdq.coupling.alignment.accessanalysis2codeql.InputModels;
...
public class IterativeAccessAnalysis2CodeQLHandler extends AccessAnalysis2CodeQLHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		IterativeAccessAnalysis2CodeQLModelsGenerator modelsGenerator = new IterativeAccessAnalysis2CodeQLModelsGenerator();
