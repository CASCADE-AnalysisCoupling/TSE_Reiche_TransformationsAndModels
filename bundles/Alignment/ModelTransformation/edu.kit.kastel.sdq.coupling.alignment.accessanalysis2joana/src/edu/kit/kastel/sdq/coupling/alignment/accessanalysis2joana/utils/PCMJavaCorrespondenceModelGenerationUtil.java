...
public class PCMJavaCorrespondenceModelGenerationUtil {
	...
	public static OperationInterface2Interface generateOperationInterface2Interface(OperationInterface pcmOpInt, Interface interf) {
		OperationInterface2Interface correspondence = PcmjavacorrespondenceFactory.eINSTANCE.createOperationInterface2Interface();
		correspondence.setPcmInterface(pcmOpInt);
		correspondence.setJavaInterface(interf);
		return correspondence;
	}
}
