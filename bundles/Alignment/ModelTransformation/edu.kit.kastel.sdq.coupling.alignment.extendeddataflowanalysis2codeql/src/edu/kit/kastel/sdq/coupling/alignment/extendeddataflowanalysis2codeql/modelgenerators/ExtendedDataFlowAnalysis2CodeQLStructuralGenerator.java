...
import edu.kit.kastel.sdq.coupling.alignment.extendeddataflowanalysis2codeql.utils.PCMResolutionUtil;

public class ExtendedDataFlowAnalysis2CodeQLStructuralGenerator {
	...
	public ExtendedDataFlowAnalysis2CodeQLStructuralGenerator(PCMJavaCorrespondenceRoot correspondences, Repository repository, String basePackageName) {
