...
public class TravelPlannerPaths {
	...
	public static final String ExtendedDataFlowAnalysis2CodeQLAlignment = Paths.get(String.format("%s/%s.%s", MODELS_BASE_PATH, PARAMETER_ANNOTATION_MODEL_NAME , PARAMETER_ANNOTATION_MODEL_FILE_ENDING)).toAbsolutePath().toString();
