...
public class JOANAClassOrInterfaceTypeCodeGenerator extends ClassOrInterfaceTypeGenerationTemplate {
  ...
  protected String generateImports() {
    ...
    final Function1<ClassOrInterfaceType, Boolean> _function_3 = (ClassOrInterfaceType coi) -> {
    ...
    final List<ClassOrInterfaceType> classOrInterfaceTypes = IterableExtensions.<ClassOrInterfaceType>toList(IterableExtensions.<ClassOrInterfaceType>filter(Iterables.<ClassOrInterfaceType>filter(types, ClassOrInterfaceType.class), _function_3));
