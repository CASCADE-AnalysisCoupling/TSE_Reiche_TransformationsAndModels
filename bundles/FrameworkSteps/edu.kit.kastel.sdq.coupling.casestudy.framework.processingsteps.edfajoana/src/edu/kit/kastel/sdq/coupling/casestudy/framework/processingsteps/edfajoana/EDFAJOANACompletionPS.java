...
public class EDFAJOANACompletionPS extends CompletionPS{
	...
	public EDFAJOANACompletionPS(Registry registry) throws MissingPathIdentifierException {
		super(registry);
	}
	...
	public static String[] getArgIds() {
		return ARG_IDS;
	}
