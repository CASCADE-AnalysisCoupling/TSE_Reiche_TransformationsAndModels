...
import edu.kit.kastel.sdq.coupling.casestudy.framework.processingsteps.edfajoana.adapter.JOANA2EDFAAdapter;
...
public class EDFAJOANAIntegrationPS extends IntegrationPS {
	...
	protected String[] getArgsForExecution() {
		...
		return Stream.concat(Arrays.stream(new String[] { "JOANAIntegrationPS: execution successful.",
				"JOANAIntegrationPS: execution not successful: " }), paths.stream()).toArray(String[]::new);
	}
