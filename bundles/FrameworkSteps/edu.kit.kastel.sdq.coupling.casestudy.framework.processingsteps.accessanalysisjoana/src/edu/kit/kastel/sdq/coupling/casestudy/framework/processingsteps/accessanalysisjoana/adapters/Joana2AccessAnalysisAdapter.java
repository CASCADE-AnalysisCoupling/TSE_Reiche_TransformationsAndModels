package edu.kit.kastel.sdq.coupling.casestudy.framework.processingsteps.accessanalysisjoana.adapters;
...
public class Joana2AccessAnalysisAdapter implements ExecutableProcessingStepAdapter {
	 ...
	 * args[15]: joana_Configurations_Location <br>
	 */
	@Override
	public Result executeAdapter(String[] args) {
		...
		try {
			Joana2AccessAnalysisResultIntegration integration = new Joana2AccessAnalysisResultIntegration(args[2],
