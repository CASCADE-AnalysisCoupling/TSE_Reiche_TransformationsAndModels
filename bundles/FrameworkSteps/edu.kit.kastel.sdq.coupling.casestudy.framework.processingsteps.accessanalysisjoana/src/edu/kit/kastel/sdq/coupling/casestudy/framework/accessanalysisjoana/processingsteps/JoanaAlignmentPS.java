package edu.kit.kastel.sdq.coupling.casestudy.framework.accessanalysisjoana.processingsteps;
...
import edu.kit.kastel.sdq.coupling.casestudy.framework.accessanalysisjoana.processingsteps.adapters.AccessAnalysis2JoanaAdapter;
...
public class JoanaAlignmentPS extends AlignmentPS {
	...
	protected static final String[] ARG_IDS = { "REPOSITORY_PATH", "CONFIDENTIALITY_MODEL_PATH", "JAVA_CODE_BASE_PATH",
			...
			"POLICY_STYLE", "ACCESSANALYSIS_JOANA_CORRESPONDENCE_PATH"};
	...
	protected String[] getArgsForExecution() {
		...
		String relPath3 = pathPrefix + super.registry.getFileForID("ACCESSANALYSIS_JOANA_CORRESPONDENCE_PATH").getPath();
