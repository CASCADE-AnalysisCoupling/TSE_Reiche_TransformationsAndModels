package edu.kit.kastel.sdq.coupling.casestudy.framework.processingsteps.accessanalysisjoana;
...
import edu.kit.kastel.sdq.coupling.casestudy.framework.processingsteps.accessanalysisjoana.adapters.Joana2AccessAnalysisAdapter;

public class JoanaIntegrationPS extends IntegrationPS {

	protected static final String USER_SPECIFIC_PATH = "USER_SPECIFIC_PATH";
	protected static final String[] ARG_IDS = { "JAVA_MODEL_PATH", "JOANA_MODEL_PATH", "JOANA_CONFIGURATIONS_PATH" ,"PCM_JAVA_CORRESPONDENCE_MODEL_PATH",
