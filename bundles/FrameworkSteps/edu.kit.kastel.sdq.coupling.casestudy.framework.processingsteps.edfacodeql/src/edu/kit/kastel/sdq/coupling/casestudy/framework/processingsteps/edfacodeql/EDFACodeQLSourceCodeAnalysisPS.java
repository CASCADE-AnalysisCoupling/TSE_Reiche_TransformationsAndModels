...
public class EDFACodeQLSourceCodeAnalysisPS extends AnalysisPS{
	...
	public EDFACodeQLSourceCodeAnalysisPS(Registry registry) throws MissingPathIdentifierException {
		super(registry);
	}
