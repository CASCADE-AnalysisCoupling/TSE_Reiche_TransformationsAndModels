package edu.kit.kastel.sdq.coupling.alignment.accessanalysis2joana.modelgenerators.iterative;
...
import edu.kit.kastel.sdq.coupling.alignment.accessanalysis2joana.modelgenerators.iterative.transitivereduction.LevelHandler;
import edu.kit.kastel.sdq.coupling.alignment.accessanalysis2joana.modelgenerators.iterative.transitivereduction.ValidRelation;
...
public class IterativeAccessAnalysis2JOANASecurityGenerator {
	...
	/**
	 * Combines the single SecurityLevels into one Camelcase? Name in which the
	 * single levels are sorted alphanumerical.
	 * 
