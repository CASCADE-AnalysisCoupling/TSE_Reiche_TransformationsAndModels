...
/**
 * This is the item provider adapter for a {@link edu.kit.kastel.sdq.coupling.models.joanascar.Flow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FlowItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addEntryPointPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Flow_entryPoint_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Flow_entryPoint_feature", "_UI_Flow_type"),
						JoanascarPackage.Literals.FLOW__ENTRY_POINT, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(JoanascarPackage.Literals.FLOW__SOURCE);
			childrenFeatures.add(JoanascarPackage.Literals.FLOW__SINK);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(JoanascarPackage.Literals.FLOW__SOURCE,
				JoanascarFactory.eINSTANCE.createSource()));

		newChildDescriptors.add(
				createChildParameter(JoanascarPackage.Literals.FLOW__SINK, JoanascarFactory.eINSTANCE.createSink()));
	}
