...
public class PCMJavaCorrespondenceRootImpl extends MinimalEObjectImpl.Container implements PCMJavaCorrespondenceRoot {
	...
	public EList<BasicComponent2Class> getBasiccomponent2class() {
		if (basiccomponent2class == null) {
			basiccomponent2class = new EObjectContainmentEList<BasicComponent2Class>(BasicComponent2Class.class, this, PcmjavacorrespondencePackage.PCM_JAVA_CORRESPONDENCE_ROOT__BASICCOMPONENT2CLASS);
		}
	...
	public EList<OperationInterface2Interface> getOperationInterface2interface() {
		if (operationInterface2interface == null) {
			operationInterface2interface = new EObjectContainmentEList<OperationInterface2Interface>(OperationInterface2Interface.class, this, PcmjavacorrespondencePackage.PCM_JAVA_CORRESPONDENCE_ROOT__OPERATION_INTERFACE2INTERFACE);
		}
	...
	public EList<CompositeDataType2Class> getCompositedatatype2class() {
		if (compositedatatype2class == null) {
			compositedatatype2class = new EObjectContainmentEList<CompositeDataType2Class>(CompositeDataType2Class.class, this, PcmjavacorrespondencePackage.PCM_JAVA_CORRESPONDENCE_ROOT__COMPOSITEDATATYPE2CLASS);
		}
	...
	public EList<ProvidedOperationSignature2JavaMethod> getProvidedoperationsignature2javamethod() {
		if (providedoperationsignature2javamethod == null) {
			providedoperationsignature2javamethod = new EObjectContainmentEList<ProvidedOperationSignature2JavaMethod>(ProvidedOperationSignature2JavaMethod.class, this, PcmjavacorrespondencePackage.PCM_JAVA_CORRESPONDENCE_ROOT__PROVIDEDOPERATIONSIGNATURE2JAVAMETHOD);
		}
	...
	public EList<PCMParameter2JavaParameter> getPcmparameter2javaparameter() {
		if (pcmparameter2javaparameter == null) {
			pcmparameter2javaparameter = new EObjectContainmentEList<PCMParameter2JavaParameter>(PCMParameter2JavaParameter.class, this, PcmjavacorrespondencePackage.PCM_JAVA_CORRESPONDENCE_ROOT__PCMPARAMETER2JAVAPARAMETER);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case PcmjavacorrespondencePackage.PCM_JAVA_CORRESPONDENCE_ROOT__PROVIDEDOPERATIONSIGNATURE2JAVAMETHOD:
				...
				getProvidedoperationsignature2javamethod().addAll((Collection<? extends ProvidedOperationSignature2JavaMethod>)newValue);
				return;
			case PcmjavacorrespondencePackage.PCM_JAVA_CORRESPONDENCE_ROOT__PCMPARAMETER2JAVAPARAMETER:
