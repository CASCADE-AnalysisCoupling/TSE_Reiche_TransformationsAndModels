...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Correspondences Access Analysis Code QL</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link edu.kit.kastel.sdq.coupling.models.accessanalysiscodeqlcorrespondence.impl.Correspondences_AccessAnalysisCodeQLImpl#getConfigurationCorrespondences_AccessAnalysisCodeQL <em>Configuration Correspondences Access Analysis Code QL</em>}</li>
 *   <li>{@link edu.kit.kastel.sdq.coupling.models.accessanalysiscodeqlcorrespondence.impl.Correspondences_AccessAnalysisCodeQLImpl#getDataSetSecurityLevelCorrespondence <em>Data Set Security Level Correspondence</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Correspondences_AccessAnalysisCodeQLImpl extends MinimalEObjectImpl.Container
		implements Correspondences_AccessAnalysisCodeQL {
	/**
	 ...
	 * @generated
	 */
	protected Correspondences_AccessAnalysisCodeQLImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AccessanalysiscodeqlcorrespondencePackage.Literals.CORRESPONDENCES_ACCESS_ANALYSIS_CODE_QL;
	}
	...
	public EList<ConfigurationCorrespondence> getConfigurationCorrespondences_AccessAnalysisCodeQL() {
		if (configurationCorrespondences_AccessAnalysisCodeQL == null) {
			configurationCorrespondences_AccessAnalysisCodeQL = new EObjectContainmentEList<ConfigurationCorrespondence>(
					...
					AccessanalysiscodeqlcorrespondencePackage.CORRESPONDENCES_ACCESS_ANALYSIS_CODE_QL__CONFIGURATION_CORRESPONDENCES_ACCESS_ANALYSIS_CODE_QL);
		}
	...
	public EList<DataSetSecurityLevelCorrespondence> getDataSetSecurityLevelCorrespondence() {
		if (dataSetSecurityLevelCorrespondence == null) {
			dataSetSecurityLevelCorrespondence = new EObjectContainmentEList<DataSetSecurityLevelCorrespondence>(
					...
					AccessanalysiscodeqlcorrespondencePackage.CORRESPONDENCES_ACCESS_ANALYSIS_CODE_QL__DATA_SET_SECURITY_LEVEL_CORRESPONDENCE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case AccessanalysiscodeqlcorrespondencePackage.CORRESPONDENCES_ACCESS_ANALYSIS_CODE_QL__CONFIGURATION_CORRESPONDENCES_ACCESS_ANALYSIS_CODE_QL:
			return ((InternalEList<?>) getConfigurationCorrespondences_AccessAnalysisCodeQL()).basicRemove(otherEnd,
					msgs);
		case AccessanalysiscodeqlcorrespondencePackage.CORRESPONDENCES_ACCESS_ANALYSIS_CODE_QL__DATA_SET_SECURITY_LEVEL_CORRESPONDENCE:
...
} //Correspondences_AccessAnalysisCodeQLImpl
