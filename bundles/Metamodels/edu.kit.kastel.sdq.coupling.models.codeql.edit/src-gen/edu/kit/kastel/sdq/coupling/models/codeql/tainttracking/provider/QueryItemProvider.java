...
/**
 * This is the item provider adapter for a {@link edu.kit.kastel.sdq.coupling.models.codeql.tainttracking.Query} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QueryItemProvider extends IdentifiedElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TainttrackingPackage.Literals.QUERY__APPLIED_SECURITY_LEVEL);
			childrenFeatures.add(TainttrackingPackage.Literals.QUERY__SECURITY_LEVEL_ANNOTATIONS);
			childrenFeatures.add(TainttrackingPackage.Literals.QUERY__ALLOWED_FLOWS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TainttrackingPackage.Literals.QUERY__APPLIED_SECURITY_LEVEL,
				 TainttrackingFactory.eINSTANCE.createSecurityLevel()));

		newChildDescriptors.add
			(createChildParameter
				(TainttrackingPackage.Literals.QUERY__SECURITY_LEVEL_ANNOTATIONS,
		...
		newChildDescriptors.add
			(createChildParameter
				(TainttrackingPackage.Literals.QUERY__ALLOWED_FLOWS,
				 TainttrackingFactory.eINSTANCE.createAllowedFlows()));
	}
