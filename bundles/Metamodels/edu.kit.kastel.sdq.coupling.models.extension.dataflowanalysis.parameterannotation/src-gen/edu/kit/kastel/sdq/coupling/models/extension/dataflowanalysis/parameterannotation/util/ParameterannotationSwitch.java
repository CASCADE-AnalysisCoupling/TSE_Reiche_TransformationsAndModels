 ...
 * @generated
 */
public class ParameterannotationSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ParameterannotationSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case ParameterannotationPackage.CHARACTERISTICS_ANNOTATION: {
		...
		case ParameterannotationPackage.GENERAL_OPERATION_PARAMETER_IDENTIFICATION: {
			GeneralOperationParameterIdentification generalOperationParameterIdentification = (GeneralOperationParameterIdentification) theEObject;
			T result = caseGeneralOperationParameterIdentification(generalOperationParameterIdentification);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ParameterannotationPackage.PROVIDED_OPERATION_PARAMETER_IDENTIFICATION: {
			ProvidedOperationParameterIdentification providedOperationParameterIdentification = (ProvidedOperationParameterIdentification) theEObject;
			T result = caseProvidedOperationParameterIdentification(providedOperationParameterIdentification);
			if (result == null)
				result = caseGeneralOperationParameterIdentification(providedOperationParameterIdentification);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ParameterannotationPackage.PARAMETER_ANNOTATION: {
			...
			if (result == null)
				result = caseCharacteristicsAnnotation(parameterAnnotation);
			if (result == null)
		...
		case ParameterannotationPackage.PARAMETER_ANNOTATIONS: {
			ParameterAnnotations parameterAnnotations = (ParameterAnnotations) theEObject;
			T result = caseParameterAnnotations(parameterAnnotations);
			if (result == null)
				result = caseIdentifiedElement(parameterAnnotations);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>General Operation Parameter Identification</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>General Operation Parameter Identification</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGeneralOperationParameterIdentification(GeneralOperationParameterIdentification object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Provided Operation Parameter Identification</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Provided Operation Parameter Identification</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProvidedOperationParameterIdentification(ProvidedOperationParameterIdentification object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Parameter Annotations</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Parameter Annotations</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseParameterAnnotations(ParameterAnnotations object) {
		return null;
	}
