 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.kastel.sdq.coupling.models.joanascar.impl.Parameter_SCARImpl#getParameterIndex <em>Parameter Index</em>}</li>
 *   <li>{@link edu.kit.kastel.sdq.coupling.models.joanascar.impl.Parameter_SCARImpl#getParameterType <em>Parameter Type</em>}</li>
 *   <li>{@link edu.kit.kastel.sdq.coupling.models.joanascar.impl.Parameter_SCARImpl#getMethodName <em>Method Name</em>}</li>
 *   <li>{@link edu.kit.kastel.sdq.coupling.models.joanascar.impl.Parameter_SCARImpl#getFullyQualifiedClassName <em>Fully Qualified Class Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Parameter_SCARImpl extends SystemElement_SCARImpl implements Parameter_SCAR {
	/**
	...
	protected EClass eStaticClass() {
		return JoanascarPackage.Literals.PARAMETER_SCAR;
	}
	...
	public void setParameterIndex(int newParameterIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JoanascarPackage.PARAMETER_SCAR__PARAMETER_INDEX,
	...
	public void setParameterType(String newParameterType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JoanascarPackage.PARAMETER_SCAR__PARAMETER_TYPE,
	...
	public void setMethodName(String newMethodName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JoanascarPackage.PARAMETER_SCAR__METHOD_NAME,
	...
	public void setFullyQualifiedClassName(String newFullyQualifiedClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					JoanascarPackage.PARAMETER_SCAR__FULLY_QUALIFIED_CLASS_NAME, oldFullyQualifiedClassName,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case JoanascarPackage.PARAMETER_SCAR__PARAMETER_INDEX:
			return getParameterIndex();
		case JoanascarPackage.PARAMETER_SCAR__PARAMETER_TYPE:
			return getParameterType();
		case JoanascarPackage.PARAMETER_SCAR__METHOD_NAME:
			return getMethodName();
		case JoanascarPackage.PARAMETER_SCAR__FULLY_QUALIFIED_CLASS_NAME:
