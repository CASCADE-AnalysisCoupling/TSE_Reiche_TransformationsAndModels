...
/**
 * This is the item provider adapter for a {@link edu.kit.kastel.sdq.coupling.models.joanaresultingvalues.Parameter_ResolvedImplementationValues} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Parameter_ResolvedImplementationValuesItemProvider extends ItemProviderAdapter
	...
	protected void addParameterIndexPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Parameter_ResolvedImplementationValues_parameterIndex_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_Parameter_ResolvedImplementationValues_parameterIndex_feature",
						"_UI_Parameter_ResolvedImplementationValues_type"),
				JoanaresultingvaluesPackage.Literals.PARAMETER_RESOLVED_IMPLEMENTATION_VALUES__PARAMETER_INDEX, true,
	...
	protected void addParameterTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_Parameter_ResolvedImplementationValues_type"),
				JoanaresultingvaluesPackage.Literals.PARAMETER_RESOLVED_IMPLEMENTATION_VALUES__PARAMETER_TYPE, true,
	...
	protected void addMethodNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_Parameter_ResolvedImplementationValues_type"),
				JoanaresultingvaluesPackage.Literals.PARAMETER_RESOLVED_IMPLEMENTATION_VALUES__METHOD_NAME, true, false,
	...
	protected void addFullyQualifiedClassNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						...
						"_UI_Parameter_ResolvedImplementationValues_type"),
				JoanaresultingvaluesPackage.Literals.PARAMETER_RESOLVED_IMPLEMENTATION_VALUES__FULLY_QUALIFIED_CLASS_NAME,
	...
	public String getText(Object object) {
		String label = ((Parameter_ResolvedImplementationValues) object).getMethodName();
