...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Correspondences Code QL Scar</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link edu.kit.kastel.sdq.coupling.models.correspondences.codeqlscarcorrespondences.impl.Correspondences_CodeQLScarImpl#getSystemElementCorrespondences <em>System Element Correspondences</em>}</li>
 *   <li>{@link edu.kit.kastel.sdq.coupling.models.correspondences.codeqlscarcorrespondences.impl.Correspondences_CodeQLScarImpl#getSecurityLevelCorrespondences <em>Security Level Correspondences</em>}</li>
 *   <li>{@link edu.kit.kastel.sdq.coupling.models.correspondences.codeqlscarcorrespondences.impl.Correspondences_CodeQLScarImpl#getConfigurationCorrespondences <em>Configuration Correspondences</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Correspondences_CodeQLScarImpl extends MinimalEObjectImpl.Container implements Correspondences_CodeQLScar {
	/**
	 ...
	 * @generated
	 */
	protected Correspondences_CodeQLScarImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CodeqlscarcorrespondencesPackage.Literals.CORRESPONDENCES_CODE_QL_SCAR;
	}
	...
	public EList<SystemElementCorrespondence> getSystemElementCorrespondences() {
		if (systemElementCorrespondences == null) {
			systemElementCorrespondences = new EObjectContainmentEList<SystemElementCorrespondence>(
					...
					CodeqlscarcorrespondencesPackage.CORRESPONDENCES_CODE_QL_SCAR__SYSTEM_ELEMENT_CORRESPONDENCES);
		}
	...
	public EList<SecurityLevelCorrespondence> getSecurityLevelCorrespondences() {
		if (securityLevelCorrespondences == null) {
			securityLevelCorrespondences = new EObjectContainmentEList<SecurityLevelCorrespondence>(
					...
					CodeqlscarcorrespondencesPackage.CORRESPONDENCES_CODE_QL_SCAR__SECURITY_LEVEL_CORRESPONDENCES);
		}
	...
	public EList<ConfigurationCorrespondence> getConfigurationCorrespondences() {
		if (configurationCorrespondences == null) {
			configurationCorrespondences = new EObjectContainmentEList<ConfigurationCorrespondence>(
					...
					CodeqlscarcorrespondencesPackage.CORRESPONDENCES_CODE_QL_SCAR__CONFIGURATION_CORRESPONDENCES);
		}
...
} //Correspondences_CodeQLScarImpl
