 ...
 * @generated
 */
public class MethodItemProvider extends EntityItemProvider {
	/**
	...
	protected void addReturnsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Method_returns_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Method_returns_feature",
								"_UI_Method_type"),
						CodePackage.Literals.METHOD__RETURNS, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CodePackage.Literals.METHOD__PARAMETERS);
			childrenFeatures.add(CodePackage.Literals.METHOD__EXPRESSIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(CodePackage.Literals.METHOD__PARAMETERS, CodeFactory.eINSTANCE.createParameter()));

		newChildDescriptors.add(createChildParameter(CodePackage.Literals.METHOD__EXPRESSIONS,
