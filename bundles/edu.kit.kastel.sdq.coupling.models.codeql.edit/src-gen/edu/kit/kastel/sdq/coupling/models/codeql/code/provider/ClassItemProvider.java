...
public class ClassItemProvider extends TypeItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CodePackage.Literals.CLASS__METHODS);
			childrenFeatures.add(CodePackage.Literals.CLASS__FIELDS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(edu.kit.kastel.sdq.coupling.models.codeql.code.Class.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(CodePackage.Literals.CLASS__METHODS, CodeFactory.eINSTANCE.createMethod()));
