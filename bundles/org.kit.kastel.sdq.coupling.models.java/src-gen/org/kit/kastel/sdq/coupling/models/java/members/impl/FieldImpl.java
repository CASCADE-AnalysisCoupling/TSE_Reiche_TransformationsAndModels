/**
 */
package org.kit.kastel.sdq.coupling.models.java.members.impl;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.kit.kastel.sdq.coupling.models.java.members.impl.FieldImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FieldImpl extends EntityImpl implements Field {
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MembersPackage.FIELD__TYPE, oldType,
							type));
			}
		}
		return type;
	...
	public void setType(Type newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MembersPackage.FIELD__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case MembersPackage.FIELD__TYPE:
			if (resolve)
				return getType();
			return basicGetType();
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == TypedElement.class) {
			...
			case TypesPackage.TYPED_ELEMENT__TYPE:
				return MembersPackage.FIELD__TYPE;
			default:
				return -1;
			}
		}
