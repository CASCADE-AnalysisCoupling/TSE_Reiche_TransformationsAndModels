 ...
 * </p>
 * <ul>
 *   <li>{@link org.kit.kastel.sdq.coupling.models.java.members.impl.ParameterImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterImpl extends EntityImpl implements Parameter {
	...
	protected EClass eStaticClass() {
		return MembersPackage.Literals.PARAMETER;
	}
	...
	public void setType(Type newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MembersPackage.PARAMETER__TYPE, oldType, type));
	}
