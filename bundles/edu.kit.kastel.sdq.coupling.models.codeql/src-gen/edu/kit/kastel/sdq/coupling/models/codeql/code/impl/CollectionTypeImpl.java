 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.kastel.sdq.coupling.models.codeql.code.impl.CollectionTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionTypeImpl extends TypeImpl implements CollectionType {
	...
	protected EClass eStaticClass() {
		return CodePackage.Literals.COLLECTION_TYPE;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CodePackage.COLLECTION_TYPE__TYPE,
							oldType, type));
			}
		}
		return type;
	...
	public void setType(Type newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodePackage.COLLECTION_TYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CodePackage.COLLECTION_TYPE__TYPE:
			if (resolve)
				return getType();
			return basicGetType();
		}
