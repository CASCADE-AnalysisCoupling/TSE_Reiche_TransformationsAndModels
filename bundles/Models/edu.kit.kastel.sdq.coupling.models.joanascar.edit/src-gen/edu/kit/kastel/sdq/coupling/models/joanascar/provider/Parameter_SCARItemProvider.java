...
/**
 * This is the item provider adapter for a {@link edu.kit.kastel.sdq.coupling.models.joanascar.Parameter_SCAR} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Parameter_SCARItemProvider extends SystemElement_SCARItemProvider {
	/**
	...
	protected void addParameterIndexPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Parameter_SCAR_parameterIndex_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Parameter_SCAR_parameterIndex_feature",
								"_UI_Parameter_SCAR_type"),
						JoanascarPackage.Literals.PARAMETER_SCAR__PARAMETER_INDEX, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Parameter_SCAR_parameterType_feature",
								"_UI_Parameter_SCAR_type"),
						JoanascarPackage.Literals.PARAMETER_SCAR__PARAMETER_TYPE, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Parameter_SCAR_methodName_feature",
								"_UI_Parameter_SCAR_type"),
						JoanascarPackage.Literals.PARAMETER_SCAR__METHOD_NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addFullyQualifiedClassNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						JoanascarPackage.Literals.PARAMETER_SCAR__FULLY_QUALIFIED_CLASS_NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((Parameter_SCAR) object).getMethodName();
