 ...
 * @generated
 */
public class AccessanalysiscodeqlcorrespondenceAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public AccessanalysiscodeqlcorrespondenceAdapterFactory() {
	...
	protected AccessanalysiscodeqlcorrespondenceSwitch<Adapter> modelSwitch = new AccessanalysiscodeqlcorrespondenceSwitch<Adapter>() {
		...
		@Override
		public Adapter caseDataSetSecurityLevelCorrespondence(DataSetSecurityLevelCorrespondence object) {
			return createDataSetSecurityLevelCorrespondenceAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.kastel.sdq.coupling.models.accessanalysiscodeqlcorrespondence.ConfigurationCorrespondence <em>Configuration Correspondence</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.kit.kastel.sdq.coupling.models.accessanalysiscodeqlcorrespondence.DataSetSecurityLevelCorrespondence <em>Data Set Security Level Correspondence</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
...
} //AccessanalysiscodeqlcorrespondenceAdapterFactory
