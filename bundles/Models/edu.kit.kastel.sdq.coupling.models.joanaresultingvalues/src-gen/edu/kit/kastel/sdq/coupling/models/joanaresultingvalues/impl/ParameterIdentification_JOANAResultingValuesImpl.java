...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Parameter Identification JOANA Resulting Values</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link edu.kit.kastel.sdq.coupling.models.joanaresultingvalues.impl.ParameterIdentification_JOANAResultingValuesImpl#getParameterIndex <em>Parameter Index</em>}</li>
 *   <li>{@link edu.kit.kastel.sdq.coupling.models.joanaresultingvalues.impl.ParameterIdentification_JOANAResultingValuesImpl#getParameterType <em>Parameter Type</em>}</li>
 *   <li>{@link edu.kit.kastel.sdq.coupling.models.joanaresultingvalues.impl.ParameterIdentification_JOANAResultingValuesImpl#getMethodName <em>Method Name</em>}</li>
 *   <li>{@link edu.kit.kastel.sdq.coupling.models.joanaresultingvalues.impl.ParameterIdentification_JOANAResultingValuesImpl#getFullyQualifiedClassName <em>Fully Qualified Class Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterIdentification_JOANAResultingValuesImpl extends MinimalEObjectImpl.Container
		implements ParameterIdentification_JOANAResultingValues {
	/**
	 ...
	 * @generated
	 */
	protected ParameterIdentification_JOANAResultingValuesImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return JoanaresultingvaluesPackage.Literals.PARAMETER_IDENTIFICATION_JOANA_RESULTING_VALUES;
	}
	...
	public void setParameterIndex(int newParameterIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					JoanaresultingvaluesPackage.PARAMETER_IDENTIFICATION_JOANA_RESULTING_VALUES__PARAMETER_INDEX,
	...
	public void setParameterType(String newParameterType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					JoanaresultingvaluesPackage.PARAMETER_IDENTIFICATION_JOANA_RESULTING_VALUES__PARAMETER_TYPE,
	...
	public void setMethodName(String newMethodName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					JoanaresultingvaluesPackage.PARAMETER_IDENTIFICATION_JOANA_RESULTING_VALUES__METHOD_NAME,
	...
	public void setFullyQualifiedClassName(String newFullyQualifiedClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					JoanaresultingvaluesPackage.PARAMETER_IDENTIFICATION_JOANA_RESULTING_VALUES__FULLY_QUALIFIED_CLASS_NAME,
...
} //ParameterIdentification_JOANAResultingValuesImpl
