 ...
 * </p>
 * <ul>
 *   <li>{@link edu.kit.kastel.sdq.coupling.models.java.types.impl.PrimitiveTypeImpl#getKind <em>Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrimitiveTypeImpl extends TypeImpl implements PrimitiveType {
	 ...
	 * @ordered
	 */
	protected static final PrimitiveTypeKinds KIND_EDEFAULT = PrimitiveTypeKinds.BOOLEAN;
	 ...
	 * @ordered
	 */
	protected PrimitiveTypeKinds kind = KIND_EDEFAULT;
	...
	public void setKind(PrimitiveTypeKinds newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.PRIMITIVE_TYPE__KIND, oldKind, kind));
	}
