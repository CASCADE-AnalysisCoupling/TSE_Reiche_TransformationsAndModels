...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>codeql</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class CodeqlExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.codeql"));
				CodeQLRoot root = CodeqlFactory.eINSTANCE.createCodeQLRoot();
