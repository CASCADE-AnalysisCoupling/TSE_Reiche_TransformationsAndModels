...
public class ParameterNodeImpl extends NodeImpl implements ParameterNode {
		...
		if (parameter != null && parameter.eIsProxy()) {
			...
			if (parameter != oldParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TainttrackingPackage.PARAMETER_NODE__PARAMETER, oldParameter, parameter));
			}
		}
		return parameter;
	}
	...
	public void setParameter(Parameter newParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TainttrackingPackage.PARAMETER_NODE__PARAMETER, oldParameter, parameter));
	}
