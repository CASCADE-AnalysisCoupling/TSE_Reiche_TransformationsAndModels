...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Field Identification</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link edu.kit.kastel.sdq.coupling.models.codeqlscar.impl.FieldIdentificationImpl#getFieldName <em>Field Name</em>}</li>
 *   <li>{@link edu.kit.kastel.sdq.coupling.models.codeqlscar.impl.FieldIdentificationImpl#getType <em>Type</em>}</li>
 *   <li>{@link edu.kit.kastel.sdq.coupling.models.codeqlscar.impl.FieldIdentificationImpl#getFullyQualifiedClassName <em>Fully Qualified Class Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FieldIdentificationImpl extends SystemElementIdentificationImpl implements FieldIdentification {
	/**
	 ...
	 * @generated
	 */
	protected FieldIdentificationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CodeqlscarPackage.Literals.FIELD_IDENTIFICATION;
	}
	...
	public void setFieldName(String newFieldName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodeqlscarPackage.FIELD_IDENTIFICATION__FIELD_NAME,
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodeqlscarPackage.FIELD_IDENTIFICATION__TYPE, oldType,
					type));
	}
	...
	public void setFullyQualifiedClassName(String newFullyQualifiedClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CodeqlscarPackage.FIELD_IDENTIFICATION__FULLY_QUALIFIED_CLASS_NAME, oldFullyQualifiedClassName,
