...
public class JOANASCARCorrespondenceUtil {
	...
	public static ParameterCorrespondence createCorrespondence(Parameter parameter_JAVA, Parameter_SCAR parameter_SCAR) {
	...
	public static EntryPointCorrespondence createCorrespondence(HybridConfiguration entryPoint_JOANA, EntryPoint_SCAR entryPoint_SCAR) {
	...
	public static boolean correspondenceExists(Field_SCAR field, JOANASCARCorrespondences correspondences) {
	...
	public static boolean correspondenceExists(Parameter_SCAR parameter, JOANASCARCorrespondences correspondences) {
	...
	public static boolean correspondenceExists(HybridConfiguration entryPoint_JOANA, JOANASCARCorrespondences correspondences) {
	...
	public static boolean correspondenceExists(EntryPoint_SCAR entryPoint_SCAR, JOANASCARCorrespondences correspondences) {
	...
	public static boolean correspondenceExists(Level_SCAR securityLevel, JOANASCARCorrespondences correspondences) {
		return correspondences.getLevelCorrespondences().stream().anyMatch(correspondence -> correspondence.getLevel_SCAR().equals(securityLevel));
	}
	...
	public static boolean correspondenceExists(Field field, Field_SCAR fieldScar, JOANASCARCorrespondences correspondences){
	...
	public static boolean correspondenceExists(Parameter parameter, Parameter_SCAR parameterScar, JOANASCARCorrespondences correspondences){
	...
	public static boolean correspondenceExists(HybridConfiguration entryPoint_JOANA, EntryPoint_SCAR entryPoint_SCAR, JOANASCARCorrespondences correspondences){
	...
	public static void createAndAddIfCorrespondenceNotExists(Field field, Field_SCAR fieldScar, JOANASCARCorrespondences correspondences) {
	...
	public static void createAndAddIfCorrespondenceNotExists(Parameter parameter, Parameter_SCAR parameterScar, JOANASCARCorrespondences correspondences) {
	...
	public static void createAndAddIfCorrespondenceNotExists(HybridConfiguration entryPoint, EntryPoint_SCAR entryPoint_SCAR, JOANASCARCorrespondences correspondences) {
	...
	public static HybridConfiguration getCorresponding(EntryPoint_SCAR entryPoint_SCAR, JOANASCARCorrespondences correspondences) {
	...
	public static EntryPoint getCorrespondingEntryPoint(EntryPoint_SCAR entryPoint_SCAR, JOANASCARCorrespondences correspondences) {
		HybridConfiguration config = correspondences.getEntryPointCorrespondences().stream().filter(correspondence -> correspondence.getEntryPoint_SCAR().equals(entryPoint_SCAR)).findFirst().get().getEntryPoint_JOANA();
		
		if(config.getMainConfigurationElement() instanceof EntryPoint) {
			return (EntryPoint)config.getMainConfigurationElement();
		} else {
			throw new RuntimeException("Not EntryPoint config");
		}	
	}
